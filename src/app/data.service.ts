...
export class DataService {
  ...
  public getElephantineData(): Observable<any> {
    return this._http.get('http://demo.infosol.com:3092/elephant')
  ...
  public getRedNotebookData(): Observable<any> {
    return this._http.get('http://demo.infosol.com:3092/red')
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      });
  ...
  public getFilteredElephantineData(_body): Observable<any> {
    return this._http.post('http://demo.infosol.com:3092/dash/elephant', _body, { headers: this.headers })
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      })
  ...
  public getTotalWeightCountPerFabric(_body: any): Observable<any> {
    return this._http.post('http://demo.infosol.com:3092/dash/panel1', _body, { headers: this.headers })
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      })
  ...
  public getTotalPercentBlackened(_body: any): Observable<any> {
    return this._http.post('http://demo.infosol.com:3092/dash/panel2/count', _body, { headers: this.headers })
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      })
  ...
  public getWeightPercentBlackened(_body: any): Observable<any> {
    return this._http.post('http://demo.infosol.com:3092/dash/panel2/weight', _body, { headers: this.headers })
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      })
  ...
  public getTotalPercentType(_body: any): Observable<any> {
    return this._http.post('http://demo.infosol.com:3092/dash/panel3/count', _body, { headers: this.headers })
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      })
  ...
  public getWeightPercentType(_body: any): Observable<any> {
    return this._http.post('http://demo.infosol.com:3092/dash/panel3/weight', _body, { headers: this.headers })
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      })
  ...
  public getLatLangsLocusGroup(_body: any): Observable<any> {
    return this._http.post('http://demo.infosol.com:3092/dash/latlang', _body, { headers: this.headers })
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      })
  ...
  public getDashboardDetailTotals(body: any): Observable<any> {
    return this._http.post('http://demo.infosol.com:3092/dash/details/totals', body, { headers: this.headers })
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      })
  ...
  public getDashboardDetailTable(body: any): Observable<any> {
    return this._http.post('http://demo.infosol.com:3092/dash/details/table', body, { headers: this.headers })
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      })
  ...
  public getEndpointWithParams(_body: any): Observable<any> {
    ...
    return this._http.post('http://demo.infosol.com:3092/test', body, { headers: this.headers })
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      })
  ...
  public getSiteLocations(_body: any): Observable<any> {
    ...
    return this._http.post('http://demo.infosol.com:3092/dash/siteLocations', body, { headers: this.headers })
      .map((response: Response) => {
        const tmpData = response.json();
        return tmpData;
      })
