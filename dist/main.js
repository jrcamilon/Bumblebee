...
var DataService = /** @class */ (function () {
    function DataService(_http) {
        this._http = _http;
        this.elephantineData = new Subject_1.Subject();
        this.redNotebookData = new Subject_1.Subject();
        this.selectedData = new Subject_1.Subject();
        this.headers = new http_1.Headers({ 'Content-Type': 'application/json' });
    }
    // Get All Data
    DataService.prototype.getElephantineData = function () {
        return this._http.get('http://70.176.243.97:3091/elephant')
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
    };
    //Processing and Input Data Services
    // Get All Data
    DataService.prototype.getRedNotebookData = function () {
        return this._http.get('http://70.176.243.97:3091/red')
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
    };
    DataService.prototype.postElephantData = function (record) {
        // post to the db
        console.log(record);
    };
    // Dashboard Services
    // Get All Data
    DataService.prototype.getFilteredElephantineData = function (_body) {
        return this._http.post('http://70.176.243.97:3091/dash/elephant', _body, { headers: this.headers })
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
    ...
    DataService.prototype.getTotalWeightCountPerFabric = function (_body) {
        return this._http.post('http://70.176.243.97:3091/dash/panel1', _body, { headers: this.headers })
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
    ...
    DataService.prototype.getTotalPercentBlackened = function (_body) {
        return this._http.post('http://70.176.243.97:3091/dash/panel2/count', _body, { headers: this.headers })
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
    ...
    DataService.prototype.getWeightPercentBlackened = function (_body) {
        return this._http.post('http://70.176.243.97:3091/dash/panel2/weight', _body, { headers: this.headers })
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
    ...
    DataService.prototype.getTotalPercentType = function (_body) {
        return this._http.post('http://70.176.243.97:3091/dash/panel3/count', _body, { headers: this.headers })
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
    ...
    // Panel 3 - Total count percentages for types 
    DataService.prototype.getWeightPercentType = function (_body) {
        return this._http.post('http://70.176.243.97:3091/dash/panel3/weight', _body, { headers: this.headers })
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
    ...
    DataService.prototype.getLatLangsLocusGroup = function (_body) {
        return this._http.post('http://70.176.243.97:3091/dash/latlang', _body, { headers: this.headers })
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
    ...
    DataService.prototype.getDashboardDetailTotals = function (body) {
        return this._http.post('http://70.176.243.97:3091/dash/details/totals', body, { headers: this.headers })
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
    ...
    DataService.prototype.getDashboardDetailTable = function (body) {
        return this._http.post('http://70.176.243.97:3091/dash/details/table', body, { headers: this.headers })
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
    };
    DataService.prototype.getEndpointWithParams = function (_body) {
        var body = { message: 'hello node!' };
        return this._http.post('http://70.176.243.97:3091/test', body, { headers: this.headers })
            .map(function (response) {
            var tmpData = response.json();
            return tmpData;
        });
...
Object.defineProperty(exports, "__esModule", { value: true });
var data_service_1 = __webpack_require__(/*! app/data.service */ "./src/app/data.service.ts");
var core_1 = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var common_1 = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
...
var AdminLayoutComponent = /** @class */ (function () {
    function AdminLayoutComponent(location, router, _ds) {
        this.location = location;
        this.router = router;
        this._ds = _ds;
        this.yScrollStack = [];
    ...
    AdminLayoutComponent = __decorate([
        ...
        __metadata("design:paramtypes", [common_1.Location, router_1.Router, data_service_1.DataService])
